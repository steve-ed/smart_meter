"""
Generate synthetic ground truth for meter 15 (2020 semi, Part L 2021).
...
Usage (from project root):
    python py/gen_ground_truth_m15.py
"""
import csv
import dataclasses
...
from sensor_model import SensorNoiseModel, apply_noise, smooth_observations, smooth_events
...
OUTPUT_PATH  = "data/ground_truth_m15_2024.csv"
...
def _run_window_table(output_path: str, dwelling: DwellingParams) -> None:
    ...
    return rows_out, true_htc, true_g, true_band
    ...
    if "event_detection" in methods:
        ...
        for label, indoor, overnight in configs:
            ...
            if tau_agg is None:
                ...
                continue
            hlc     = calculate_hlc(tau_agg, floor_area, "semi", "post_1980")
