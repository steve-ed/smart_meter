...
METER_PARAMS: dict[int, DwellingParams] = {
    ...
    9: DwellingParams(
        ...
        u_window=2.80, u_door=2.40,
        y_value=0.11, q50=8.5, kappa=158,
        sensor_elec_meter=True, sensor_gas_meter=True,
        sensor_outdoor_temp=True, sensor_wind_speed=True,
    ),
    10: DwellingParams(
        ...
        total_floor_area_m2=88.0, storey_height_m=2.4,
        window_area_m2=15.0, door_area_m2=3.6,
        u_wall=0.45, u_roof=0.20, u_floor=0.35,
        u_window=2.00, u_door=2.00,
        y_value=0.10, q50=8.0, kappa=155,
        sensor_elec_meter=True, sensor_gas_meter=True,
        sensor_outdoor_temp=True, sensor_wind_speed=True,
    ),
    11: DwellingParams(
        ...
        u_window=1.80, u_door=1.80,
        y_value=0.09, q50=7.0, kappa=150,
        sensor_elec_meter=True, sensor_gas_meter=True,
        sensor_outdoor_temp=True, sensor_wind_speed=True,
    ),
    12: DwellingParams(
